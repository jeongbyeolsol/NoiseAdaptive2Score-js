...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=8200, help='visdom port of the web display')
        ...
        parser.add_argument('--validation_random_poisson', action='store_true',
                            help='generate deterministic per-image Poisson validation noise over the configured lambda range')
